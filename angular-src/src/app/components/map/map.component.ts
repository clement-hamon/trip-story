...
const ol_Geom_Line = require('ol/geom/linestring').default;
...
export class MapComponent implements OnInit {
  ...
  // OSR backup route
  base_osr_url= 'https://api.openrouteservice.org/directions?profile=foot-hiking&preference=fastest&units=m&language=en&geometry=true&geometry_format=encodedpolyline&geometry_simplify=false&instructions=true&instructions_format=text&elevation=false&options=%7B%7D'
  osr_api_key = '58d904a497c67e00015b45fcab3b6276dc544c09479e1f123a242179';
